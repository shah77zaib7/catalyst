...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DjQotwMy.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BnKxsYvQ.mjs").then((n) => n.i).then((n) => n.t),
...
//#endregion
export { getServerFnById as a, getRequest as i, __exportAll as n, ssr_exports as o, createServerFn as r, TSS_SERVER_FUNCTION as t };
