...
//#region node_modules/.nitro/vite/services/ssr/assets/button-DfjYkaSv.js
...
var buttonVariants = cva("inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0", {
	variants: {
		variant: {
			primary: "rounded-[var(--radius-control)] bg-accent text-accent-foreground shadow-[var(--shadow-border)] transition-[opacity,transform,box-shadow] duration-[var(--motion-fast)] ease-[var(--ease-spring)] hover:opacity-90",
			default: "rounded-[var(--radius-control)] bg-accent text-accent-foreground shadow-[var(--shadow-border)] transition-[opacity,transform,box-shadow] duration-[var(--motion-fast)] ease-[var(--ease-spring)] hover:opacity-90",
			secondary: "rounded-[var(--radius-control)] bg-muted text-foreground transition-[background-color,transform] duration-[var(--motion-fast)] ease-[var(--ease-spring)] hover:bg-muted/80",
			glass: "surface-glass surface-glass-interactive rounded-[var(--radius-control)] text-foreground",
			outline: "surface-glass surface-glass-interactive rounded-[var(--radius-control)] text-foreground",
			ghost: "rounded-[var(--radius-control)] text-foreground transition-[background-color,transform] duration-[var(--motion-fast)] ease-[var(--ease-spring)] hover:bg-muted/70",
			destructive: "rounded-[var(--radius-control)] bg-destructive/12 text-destructive transition-[background-color,transform] duration-[var(--motion-fast)] ease-[var(--ease-spring)] hover:bg-destructive/18",
...
function Button({ className, variant, size, asChild = false, static: isStatic, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(asChild ? Slot : "button", {
		className: cn(buttonVariants({
			variant,
			size
		}), !isStatic && "active:not-disabled:scale-[0.97]", className),
		...props
	});
}
//#endregion
export { useCurrentUserState as i, signIn as n, signOut as r, Button as t };
